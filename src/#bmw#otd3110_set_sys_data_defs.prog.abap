...
SELECTION-SCREEN:BEGIN OF BLOCK b1 WITH FRAME TITLE TEXT-cs1. "Client settings
  PARAMETERS:
...
SELECTION-SCREEN:BEGIN OF BLOCK b2 WITH FRAME TITLE TEXT-ss1. "System settings
  PARAMETERS:
...
SELECTION-SCREEN:BEGIN OF BLOCK b3 WITH FRAME TITLE TEXT-ups. "User profile settings
  PARAMETERS:
...
SELECTION-SCREEN:BEGIN OF BLOCK b4 WITH FRAME TITLE TEXT-atc. "ATC settings
  PARAMETERS:
